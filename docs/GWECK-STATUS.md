...
| 24 | Black inactive window on FIRST boot after install; recovers in ~30 s; later boots clean | **OPEN - not explained by #22 or #23** | Now carries a detail we never had before: **first-boot only and self-recovering**, on 25H2. Needs its own investigation; do not fold it into the fixed items |
