# Deploy a new gui-agent AND set ShellManaged=1 (draggable shell surfaces), then restart.
...
Set-ItemProperty $k -Name ShellManaged -Value 1 -Type DWord   # draggable shell surfaces
